    ...
    <div class="card">
      <div class="cardarea">
        <div class="basic-login-form-ad">
            ...
            <form method="POST" action="{{route('branch.update',$branch->id)}}" class="form-horizontal form-label-left">
              {{csrf_field()}}
        @method('PUT')
              ...
              <div class="form-group-inner row">
                ...
                <div class="col-md-10 col-sm-9 col-xs-12">
                    <textarea name="address"  class="form-control" onkeyup="getSourceLatLong(this.value)" id="" cols="10" rows="5">{{$branch->address}}</textarea>
