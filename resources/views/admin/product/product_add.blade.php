...
<div class="basic-form-area mg-b-15">
  <div class="container-fluid sparkline13-list">
    <div class="page-header">
      <h2 class="main-content-title">Add Product</h2>
      <ol class="breadcrumb">
    ...
    <div class="card">
      <div class="cardarea">
        <div class="basic-login-form-ad">
            ...
            <form method="POST" action="{{url('add-product')}}" class="form-horizontal form-label-left" enctype="multipart/form-data">
              {{csrf_field()}}
              ...
              <div class="form-group-inner row">
                ...
                <div class="col-md-10 col-sm-9 col-xs-12">
                  ...
                  @if($errors->has('title')) {{$errors->first('title')}} @endif </div>
              </div>
              <div class="form-group-inner row">
              ...
              <div class="form-group-inner row">
                ...
                <div class="col-md-10 col-sm-9 col-xs-12">
                  ...
                  @if($errors->has('cost')) {{$errors->first('cost')}} @endif </div>
              </div>
                <div class="form-group-inner row">
